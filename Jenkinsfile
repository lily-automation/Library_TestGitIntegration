	pipeline {
		...
		//agent {
		//	node {
		//		label 'Lily-Node-Test'
		//		customWorkspace 'C:\\Users\\uyenl\\Documents\\Jenkins\\.jenkins\\workspace'
		//	}
		//}
	    ...
	    environment {
	        ...
	        UIPATH_ORCH_LOGICAL_NAME = "LilyNgo"
